...
const RecruitersStats = () => {
  ...
  return (
    <section
      className="w-full bg-[#000B24] py-2 md:py-4 px-6 md:px-12 text-center relative overflow-hidden bg-cover bg-center"
      style={{ backgroundImage: `url(${Dots})` }}
    >

      <div className="max-w-5xl mx-auto relative z-10 py-2 md:space-y-8">
        {/* Headline */}
